"use strict";
/**
 * Real World Example for the Flyweight Design Pattern
 *
...
/**
 * The VehicleFlyweight class stores only the shared portion of the state
 */
...
/**
 * The Vehicle class constains the intrinsic state and a reference to the shared
 * state
 */
class Vehicle {
...
class VehicleFactory {
    /**
     * Checks if the external state exists in the cache, otherwise it creates a
     * new one and stores it for reusing in the future
     */
...
VehicleFactory.vehicleFlyweights = new Map();
/**
 * The client code is not aware of the internal representation, so no reference
 * to Flyweight objects are present.
 */
