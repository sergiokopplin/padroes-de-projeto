"use strict";
/**
 * Real World Example for the Visitor design pattern
 *
 ...
 */
/**
 * Each product component will implement the accept method to return the
 * associated cost
 */
...
/**
 * We will have 2 different visitors implementing the interface. One to
...
/**
 * The client code can be factored to reuse several visitors with the same
 * product set.
 */
