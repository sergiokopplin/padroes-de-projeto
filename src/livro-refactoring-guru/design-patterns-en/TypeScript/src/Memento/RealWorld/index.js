"use strict";
/**
 * Real World Example for the Memento design pattern
 *
...
class EmployeeOriginator {
    ...
    /* We don't need a public getter to save montly expenses limit to the state,
       as it's the employee who has the responsibility of saving their own state */
...
/**
 * The Caretaker doesn't need to access the state of the originator.
 */
...
/**
 * The client code only interacts with mementos via the caretaker.
 */
