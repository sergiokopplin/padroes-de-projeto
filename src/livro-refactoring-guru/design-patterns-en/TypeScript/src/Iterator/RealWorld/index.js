"use strict";
/**
 * Real World Example for the Iterator design pattern
 *
...
class Contact {
    constructor(name) {
        this.name = name;
        this.contacts = [];
        this.iteratorFirstLevelIndex = 0;
...
/**
 * The client code can use the for..of syntax to traverse the first 2 levels of
 * the contact tree
 */
