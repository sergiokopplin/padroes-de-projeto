"use strict";
/**
 * Real World Example for the Bridge Design Pattern
 *
 ...
 *
 * Credits to: https://github.com/martincrb/bridge-design-
 * pattern/blob/main/bridgePattern.ts
 */
/**
 * The Abstraction defines the interface for the first dimension, in this case
 * the different list item views we have for a given content
 */
...
/**
 * Now we can extend the Abstraction with the different views and independently
...
/**
 * Time to create the different implementations, in this case the different
...
/**
 * The client code only depends on the Abstraction. Now we can extend
 * abstractions (i.e. add new views) without impacting implementations (content
 * types). Also we can add new content types without impacting anything from the
 * views.
 */
const content = [
...
/**
 * The client code can use any Abstraction to render items
 */
